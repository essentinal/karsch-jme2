...
public class TextQuadUtils {
	...
	private BufferedImage getImage(Vector2f scaleFactors) {
		...
		int actualX = (int) width + kernelSize + 1 + Math.abs(shadowOffsetX);

		int actualY = (int) (g2d.getFontMetrics().getHeight() * lines)  + kernelSize + 1
		...
		float wrappingWidth = maxLineWidth;
